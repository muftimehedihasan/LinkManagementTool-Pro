                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            @if(session('success'))
                                <div class="bg-green-100 border border-green-400 text-sm text-green-700 px-4 py-2 rounded mb-4">
                                    {{ session('success') }}
                                </div>
                            @endif

                            {{-- <a href="{{ route('links.create') }}" class=" align-right bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                Create New Link
                            </a> --}}


                            <div class="flex justify-end">
                                <a href="{{ route('links.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white text-sm py-1 px-2 rounded">
                                    Create link
                                </a>
                            </div>
