                        ...
                        <div id="filterDropdown" class="z-10 hidden w-48 p-3 bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                                <li class="flex items-center">
                                    <input id="domain" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                    <label for="education" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Domain</label>
                                </li>
                                <li class="flex items-center">
                                    ...
                                    <label for="tag" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Tag</label>
                                </li>
                                <li class="flex items-center">
                                    <input id="creator" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                    <label for="creator" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Creator</label>
                                </li>
                            </ul>
                        </div>
                    </div>
