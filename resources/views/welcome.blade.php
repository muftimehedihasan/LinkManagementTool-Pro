...
<div class="hero bg-orange-100 min-h-screen">
    <div class="hero-content flex-col lg:flex-row-reverse px-12">
      ...
      <div>
        ...
        {{-- <button class="btn btn-primary" ><a href="{{ url('/dashboard') }}">Get Started</a></button> --}}
        <button class="btn btn-primary" onclick="location.href='{{ url('/dashboard') }}'">Get Started</button>
